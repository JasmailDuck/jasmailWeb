...
const Navbar = () => {
  ...
  return (
    <nav id="navbarwrapper" className=" flex justify-center flex-col">
      <div
        id="navbarcontainer"
      ...
      >
        <m.div
          ...
          className=" h-20 rounded-lg justify-end px-2 mt-4"
        >
        ...
        <m.div
          ...
          className=" bg-neutral-800 w-full h-20 rounded-lg flex items-center px-2"
        >
          <h1 className=" flex-1 text-white  ">Jasmail Duck</h1>
      ...
      <AnimatePresence>
        {showMenu == "displayMenu" && (
          <m.div className=" h-96 w-full p-2 ">
            <m.div
              layoutId="displayMenu"
              className=" bg-neutral-800 rounded-lg tracking-wider flex flex-col p-2 mb-5"
            >
